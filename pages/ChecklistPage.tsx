...
const ChecklistPage: React.FC<{ user: User }> = ({ user }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
        <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-200 h-full transition-colors duration-300">
